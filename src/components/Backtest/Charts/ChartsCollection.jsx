...
function ChartsCollection({ period_timeseries_stats, daily_timeseries_stats}) {
  ...
  const chartsData = {
    ...
    'SimpleReturn': <LineChart data={getChartData(dailyReturnArray, periodReturnArray)} />,
    'Drawdown': <LineChart data={getChartData(dailyDrawdownArray, periodDrawdownArray)} />,
    "CumReturn": <LineChart data={getChartData(dailyCumReturnArray, periodCumReturnArray)} />,
